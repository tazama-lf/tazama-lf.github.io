...
b. The TSC may adopt a code of conduct (“CoC”) for the Project, which is subject to approval by LF Charities. In the event that a Project-specific CoC has not been approved, the LF Charities Code of Conduct listed at https://lf-charities.dev/policies/ will apply for all Collaborators in the Project.
